...
def resample_prices(close_prices, freq='M'):
    ...
    tmp = pd.DataFrame(close_prices)
    aaa = tmp.resample(freq).ffill()
...
def portfolio_returns(df_long, df_short, lookahead_returns, n_stocks):
    ...
    df_temp  = df_long/n_stocks - df_short/n_stocks
    portfolio_returns = lookahead_returns*df_temp
...
def analyze_alpha(expected_portfolio_returns_by_date):
    ...
    # TODO: Implement Function
    null_hypothesis = 0.0
    t_value, p_2sideVal = stats.ttest_1samp(expected_portfolio_returns_by_date, null_hypothesis)
    p_value = p_2sideVal/2
